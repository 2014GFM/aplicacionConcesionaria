...
CREATE TABLE `compradores` (
  `idcompradores` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `compradores` VALUES (5,'Sebastian','Gomez',21987234,280000),(6,'Gaston','Rodriguez',19000432,360000),(7,'Joaquin','Gonzalez',947654123,145000);
